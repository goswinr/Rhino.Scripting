...
module CombineIntoOneFile =
    ...
    let run() =
        ...
        // this is to work around a race condition in gh actions build when both net48 and net7 builds run in parallel and one write is blocked:
        let currentLines = IO.File.ReadAllLines "Src/AutoGeneratedCode/AllScriptingFilesCombinedIntoOne_DontEditThisFile.fs"
